...
public interface SearchTreeInterface <T extends Comparable <? super T>> extends TreeInterface <T> {
    ...
    */
     ...
     * @param entry An object to be found
     * @return the object that was found or null, if it was not
    found
     */
     ...
     * @return null if newEntry was added, and the old entry in
    case
     * of replacement
     */
     ...
     * @return either the object that was removed, or null if no
    such
     * object exists
     */
